...
public class CopyOfLoginTask extends AsyncTask<Object, Void, Boolean> {
    ...
    public CopyOfLoginTask(Connection c, String host, int port, String service, String user,
    ...
    protected Boolean doInBackground(Object... params) {
        ...
        // String avatarPath =
        // prefs.getString(AndroidRsaConstants.ENCODED_IMAGE_PATH,
        // "default");
        // ProviderManager.getInstance().addIQProvider("vCard",
        // "vcard-temp",
        // new VCardProvider());
        // vCard.load(con);
        // byte[] bytes = ReadFileAsByteArray.getBytesFromFile(new
        // File(avatarPath));
